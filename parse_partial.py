...
lines = []
lines.append("# Partial Allocator Benchmark Report (In Progress...)")
...
with open("/usr/local/google/home/yairg/.gemini/jetski/brain/8817a01d-ca7a-49a4-8ac2-f6fbb90ffcfb/partial_tcache_report.md", "w") as f:
    f.write("\n".join(lines))
