...
void ClusterInfoFanoutOperation::OnResponse(
  ...
  if (consistency_required_) {
    ...
    if (ForceInfoClusterInconsistentError.GetValue()) {
      error_status =
