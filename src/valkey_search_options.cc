...
static auto use_coordinator = config::BooleanBuilder(kUseCoordinator, false)
                                  ...
                                  .Build();
/// Should this instance enable vector externalizing?
...
vmsdk::config::Boolean& GetEnableVectorSharing() {
  return dynamic_cast<vmsdk::config::Boolean&>(*enable_vector_sharing);
}
