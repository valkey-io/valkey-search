...
INSTANTIATE_TEST_SUITE_P(
    ...
    ValuesIn<FTSearchParserTestCase>({
        ...
        {
            .test_name = "language_parameter_english",
            .success = true,
            .params_str = " PARAMS 2",
        ...
        // Combined parameter tests
        {
            ...
            .k = 10,
            .ef = 150,
            .search_parameters_str = "LANGUAGE english NOSTOPWORDS VERBATIM INORDER SLOP 2",
            .no_stop_words = true,
            .verbatim = true,
            .inorder = true,
            .slop = 2,
        },
        {
            ...
            .ef = 0,
            .score_as = "",
            .search_parameters_str = "LANGUAGE spanish NOSTOPWORDS VERBATIM SLOP 1",
            .vector_query = false,
            .no_stop_words = true,
            .verbatim = true,
            .slop = 1,
        },
        {
            ...
            .k = 8,
            .search_parameters_str = "LANGUAGE german NOSTOPWORDS VERBATIM INORDER SLOP 4 TIMEOUT 300",
            .timeout_ms = 300,
            .no_stop_words = true,
            .verbatim = true,
            .inorder = true,
        ...
        // Mixed with existing parameters
        {
            ...
            .search_parameters_str = "RETURN 2 field1 field2 LANGUAGE french NOSTOPWORDS TIMEOUT 400",
            .timeout_ms = 400,
            .no_stop_words = true,
        },
    }),
