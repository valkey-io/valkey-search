    ...
    @parameterized.named_parameters(
        ...
        dict(
            ...
            config=stability_runner.StabilityTestConfig(
                ...
                bgsave_interval_sec=15,  # Keep normal interval for save/restore testing
                ...
                randomize_bg_job_intervals=True,
                num_memtier_threads=20,  # High throughput for HSET
                num_memtier_clients=20,  # High throughput for HSET
                num_search_clients=10,
                insertion_mode="time_interval",
                test_time_sec=500,  # 5 minutes to fill memory and trigger OOM
                test_timeout=600,  # 10 minutes total including recovery
                keyspace_size=10000000,  # Large keyspace to exceed memory limit
