...
// Precomputes the IDF from the stats, then scores the leaf. Mirrors what
// ScoringSession does per leaf; the direct-math tests use it to score a single
// stats object in one call.
