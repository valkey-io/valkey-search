...
static float InnerProductDistance(const void *pVect1, const void *pVect2,
  ...
  return 1.0f -
         (InnerProduct(pVect1, pVect2, qty_ptr) * reciprocal_mag_product);
}
...
static ProductFUNC<float> InnerProductSIMD16Ext = InnerProductSIMD16ExtSSE;
static ProductFUNC<float> InnerProductSIMD4Ext = InnerProductSIMD4ExtSSE;
