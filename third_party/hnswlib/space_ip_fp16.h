...
static float InnerProductFP16(const void *pVect1, const void *pVect2,
                              const void *qty_ptr) {
  const float16 *pVect1f = static_cast<const float16 *>(pVect1);
  const float16 *pVect2f = static_cast<const float16 *>(pVect2);
...
static float InnerProductDistanceFP16(const void *pVect1, const void *pVect2,
                                      const void *qty_ptr,
