...
static float L2SqrSIMD16ExtResiduals(const void *pVect1v, const void *pVect2v,
  ...
  float res = L2SqrSIMD16Ext(pVect1v, pVect2v, &qty16, product_magnitude);
  float *pVect1 = (float *)pVect1v + qty16;
  float *pVect2 = (float *)pVect2v + qty16;

  size_t qty_left = qty - qty16;
  float res_tail = L2Sqr(pVect1, pVect2, &qty_left, product_magnitude);
  return (res + res_tail);
}
#endif
...
static float L2SqrSIMD4ExtResiduals(const void *pVect1v, const void *pVect2v,
  ...
  float res = L2SqrSIMD4Ext(pVect1v, pVect2v, &qty4, product_magnitude);
...
static int L2SqrI4x(const void *__restrict pVect1,
                    ...
                    [[maybe_unused]] int product_magnitude) {
  size_t qty = *((size_t *)qty_ptr);
  int res = 0;
