...
static float L2SqrBF16(const void *pVect1v, const void *pVect2v,
                       const void *qty_ptr,
                       [[maybe_unused]] float product_magnitude) {
  const bfloat16 *pVect1 = static_cast<const bfloat16 *>(pVect1v);
  const bfloat16 *pVect2 = static_cast<const bfloat16 *>(pVect2v);
...
#if defined(USE_SIMSIMD)
static float L2SqrBF16Simsimd(const void *pVect1, const void *pVect2,
                              const void *qty_ptr,
                              [[maybe_unused]] float product_magnitude) {
