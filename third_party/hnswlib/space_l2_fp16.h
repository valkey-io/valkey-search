...
static float L2SqrFP16(const void *pVect1v, const void *pVect2v,
                       const void *qty_ptr,
                       [[maybe_unused]] float product_magnitude) {
  const float16 *pVect1 = static_cast<const float16 *>(pVect1v);
...
#if defined(USE_SIMSIMD)
static float L2SqrFP16Simsimd(const void *pVect1, const void *pVect2,
                              const void *qty_ptr,
                              [[maybe_unused]] float product_magnitude) {
