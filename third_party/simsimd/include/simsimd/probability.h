...
static inline __m256 simsimd_log2_f32_haswell(__m256 x) {
    // Extracting the exponent
...
static inline __m512 simsimd_log2_f32_skylake(__m512 x) {
...
static inline __m512h simsimd_log2_f16_sapphire(__m512h x) {
    // Extract the exponent and mantissa
